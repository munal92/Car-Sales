...
const App = (props) => {
  ...
  function sortObj(recObj) {
    return {
      ...recObj,
      additionalFeatures: recObj.additionalFeatures.sort(function (a, b) {
        return a.id - b.id;
      }),
    };
  }
  ...
  return (
    <div className="boxes">
      ...
      <div className="box">
        <AdditionalFeatures
          buyItem={buyItem}
          additionalFeatures={sortObj(props.carFeaturesData).additionalFeatures}
        />
        <Total
          car={props.carData.car}
          additionalPrice={props.carFeaturesData.additionalPrice}
        />
      </div>
    </div>
  );
